...
struct layer {
    ...
    float *drop_mask;
    float *s_momentum;
    float *scale_updates_accum;
    float *bias_updates_accum;
    int trunk;
    int count;
    float *drop_imp;
    float *center_vector;
    float *center_vector_scales;
    float *center_vector_biases;

	float *center_updates;
    float *center_updates_scales;
    float *center_updates_biases;
...
//#ifdef GPU
    ...
    /* NJ */
    float * dot_product_gpu;
    float * scaling_gpu;
    float * drop_mask_gpu;
    float * s_momentum_gpu;
    float * scale_updates_accum_gpu;
    float * bias_updates_accum_gpu;
    float * m_buffer_gpu;
    float * m_buffer_b_gpu;
    ...
    float *center_updates_gpu;
    float *center_updates_scales_gpu;
    float *center_updates_biases_gpu;
